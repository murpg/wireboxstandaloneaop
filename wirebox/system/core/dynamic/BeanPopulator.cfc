...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
    ...
    <cffunction name="init" output="false" access="public" returntype="BeanPopulator" hint="Constructor">
    	<cfscript>
    		JSONUtil  = createObject("component","wirebox.system.core.conversion.JSON").init();
			mixerUtil = createObject("component","wirebox.system.core.dynamic.MixerUtil").init();
...
<!------------------------------------------- PRIVATE ------------------------------------------>
	...
	<!--- Get ColdBox Util --->
	<cffunction name="getUtil" access="private" output="false" returntype="wirebox.system.core.util.Util" hint="Create and return a util object">
