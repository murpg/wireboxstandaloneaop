...
----------------------------------------------------------------------->
<cfcomponent implements="wirebox.system.ioc.IProvider" hint="A WireBox provider object that retrieves objects by using the provider pattern." output="false">
    ...
    <cffunction name="init" output="false" access="public" returntype="Provider" hint="Constructor">
		...
		<cfargument name="scopeStorage" 	 required="true" hint="The scope storage utility" 				  colddoc:generic="wirebox.system.core.collections.ScopeStorage"/>
